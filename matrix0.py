...
def main():
    ...
    while True:
        ...
        val0 = boxes[0].number * boxes[4].number + boxes[1].number * boxes[6].number
        val1 = boxes[0].number * boxes[5].number + boxes[1].number * boxes[7].number
        val2 = boxes[2].number * boxes[4].number + boxes[3].number * boxes[6].number
        val3 = boxes[2].number * boxes[5].number + boxes[3].number * boxes[7].number
